...
import { MicroProcurementVisualsComponent } from './micro-procurement-report/micro-procurement-visuals/micro-procurement-visuals.component';
...
@NgModule({
  declarations: [
    ...
    MicroProcurementVisualsComponent,
  ],
  imports: [
    CommonModule,
